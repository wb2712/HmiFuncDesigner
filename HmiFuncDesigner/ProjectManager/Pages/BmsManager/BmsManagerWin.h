#ifndef BMSMANAGERWIN_H
#define BMSMANAGERWIN_H
...
class BmsTableModel : public QAbstractTableModel
{
    Q_OBJECT
...
public:
    explicit BmsTableModel(QObject *parent = nullptr) : QAbstractTableModel(parent) {}
...
public:
    BmsTableModel *m_pBmsTableModel = NULL;
...
class BmsManagerWin : public QWidget
{
    Q_OBJECT
public:
    explicit BmsManagerWin(QWidget *parent = NULL);
    ~BmsManagerWin();
