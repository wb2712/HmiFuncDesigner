#ifndef CMDMANAGERWIN_H
#define CMDMANAGERWIN_H
...
class CmdTableModel : public QAbstractTableModel
{
    Q_OBJECT
...
public:
    explicit CmdTableModel(QObject *parent = nullptr) : QAbstractTableModel(parent) {}
...
public:
    CmdTableModel *m_pCmdTableModel = NULL;
...
class CmdManagerWin : public QWidget
{
    Q_OBJECT
public:
    explicit CmdManagerWin(QWidget *parent = NULL);
    ~CmdManagerWin();
