#ifndef DEVMODLEPLUGIN_H
#define DEVMODLEPLUGIN_H

#include "../../libs/core/qabstractpage.h"

#define PLUGIN_NAME "Plugin.Page.DevModle"

class DevModlePlugin : public QAbstractPage
{
    Q_OBJECT
    Q_INTERFACES(QPluginInterface)
    Q_PLUGIN_METADATA(IID QPluginInterface_iid FILE "DevModlePlugin.json")
public:
