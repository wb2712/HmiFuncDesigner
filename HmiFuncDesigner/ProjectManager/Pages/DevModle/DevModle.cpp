...
DevModle::DevModle(QWidget *parent) : QWidget(parent)
{
    ...
    connect(m_pListViewCommDevObj, &QAbstractItemView::doubleClicked, this,
            &DevModle::onSlotListViewProjectDoubleClicked);
...
void DevModle::listViewUISetting()
{
    m_pListViewCommDevObj->setViewMode(QListView::IconMode);
    m_pListViewCommDevObj->setViewportMargin(0, 0, 0, 0);
    m_pListViewCommDevObj->setIconSize(QSize(32, 32));
...
void DevModle::listViewUpdate()
{
    if(m_szItemName == QString("DevModle").toUpper()) { // 通讯设备
...
/**
 * @brief DevModle::listViewDevModleUpdate
 * @details 所有通讯设备列表视图
 */
void DevModle::listViewDevModleUpdate()
{
...
/**
 * @brief DevModle::listViewCOMDeviceUpdate
 * @details 串口通讯设备列表视图
 */
void DevModle::listViewCOMDeviceUpdate()
{
    m_pCommDevModelObj->clear();
    listViewUISetting();
...
/**
 * @brief DevModle::listViewNetDeviceUpdate
 * @details 网络通讯设备列表视图
 */
void DevModle::listViewNetDeviceUpdate()
{
    m_pCommDevModelObj->clear();
    listViewUISetting();
...
void DevModle::contextMenuEventSlot(QContextMenuEvent * event)
{
...
* 右键菜单
*/
void DevModle::contextMenuEvent(QContextMenuEvent * event)
{
...
* 插槽：修改通讯设备参数
*/
void DevModle::onSlotModifyDevice()
{
...
* 插槽：删除通讯设备
*/
void DevModle::onSlotDeleteDevice()
{
    QModelIndex idx = m_pListViewCommDevObj->selectionModel()->currentIndex();
    QStandardItem *pItemObj = m_pCommDevModelObj->itemFromIndex(idx);
...
void DevModle::onSlotListViewProjectDoubleClicked(const QModelIndex &index)
{
