...
DevModleDialog::DevModleDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::DevModleDialog)
{
    ui->setupUi(this);
...
void DevModleDialog::save(const QString &szName)
{
    ...
    pObj->ProtoType = stringToEnum<CEmsPropertySheet::EmsProto>(ui->BusType->currentText());
...
QString DevModleDialog::getValue2ByValue1(const QString &szVal1,
...
void DevModleDialog::setValue2ByValue1(const QString &szVal1,
