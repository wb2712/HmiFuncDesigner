...
DevEditDialog::DevEditDialog(QWidget *parent, Tag *objTag)
    : QDialog(parent),
      ui(new Ui::DevEditDialog)
{
    ui->setupUi(this);
    ...
    if(objTag)
    {
        m_objTag = static_cast<DeviceTag*>(objTag);
...
DevEditDialog::~DevEditDialog()
{
    delete ui;
}

///
/// \brief DevEditDialog::setInfosAndTagObj
/// @details 设置变量信息
/// \param jsonTag 变量
///
void DevEditDialog::setTagObj(QJsonObject &jsonTag)
{
...
///
/// \brief DevEditDialog::getTagObj
/// @details 返回变量信息
/// \return 变量信息
///
QJsonObject DevEditDialog::getTagObj()
{
    return m_jsonTagObj;
}
...
///
/// \brief DevEditDialog::setAddrTypeLimit
/// \details 设置地址类型的限制范围
/// \param mapLimit
///
void DevEditDialog::setAddrTypeLimit(QMap<QString, QMap<QString, quint32>> mapLimit)
{
...
///
/// \brief DevEditDialog::on_btnOk_clicked
/// \details 单击确定按钮
///
void DevEditDialog::on_btnOk_clicked()
{
    bool bOk = false;
...
///
/// \brief DevEditDialog::on_btnCancel_clicked
/// \details 单击取消按钮
///
void DevEditDialog::on_btnCancel_clicked()
{
    this->reject();
}

///
/// \brief DevEditDialog::on_cboAddrType_currentTextChanged
/// \details 地址类型改变
/// \param szAddrType
///
void DevEditDialog::on_cboAddrType_currentTextChanged(const QString &szAddrType)
{
    if(szAddrType == "") {
        return;
    }
...
void DevEditDialog::on_cboAddrType2_currentTextChanged(const QString &szAddrType)
{
    if(szAddrType == "") {
        return;
    }
...
///
/// \brief DevEditDialog::updateUI
/// \details 更新UI
///
void DevEditDialog::updateUI()
{
    ui->tabWidget->setCurrentIndex(0);
...
///
/// \brief DevEditDialog::on_cboDev_currentIndexChanged
/// \details 设备改变
/// \param szDev 设备名称
///
void DevEditDialog::on_cboDev_currentIndexChanged(const QString &szDev)
{
...
void DevEditDialog::on_btnSave_clicked()
{
